...
parser.add_argument('distribution', choices=['gaussian_0', 'gaussian_1', 'chi_square_9', 'exp_9', 'gaussian_mixture'], help='the univariate probaility distribution from which data should be sampled')
