...
parser.add_argument('dataset_1_label', help='a label describing what distinguishes dataset 1, typically a cognitive process label')
...
parser.add_argument('dataset_2_label', help='a label describing what distinguishes dataset 2, typically a cognitive process label')
...
real_dataset_1, real_dataset_1_tags = real_dataset_1_brainpedia.all_data()
syn_dataset_1, syn_dataset_1_tags = syn_dataset_1_brainpedia.all_data()
real_dataset_2, real_dataset_2_tags = real_dataset_2_brainpedia.all_data()
syn_dataset_2, syn_dataset_2_tags = syn_dataset_2_brainpedia.all_data()
...
real_dataset_1_img = invert_preprocessor_scaling(real_dataset_1[0].squeeze(), real_dataset_1_brainpedia.preprocessor)
real_dataset_2_img = invert_preprocessor_scaling(real_dataset_2[0].squeeze(), real_dataset_2_brainpedia.preprocessor)
syn_dataset_1_img = invert_preprocessor_scaling(syn_dataset_1[0].squeeze(), syn_dataset_1_brainpedia.preprocessor)
syn_dataset_2_img = invert_preprocessor_scaling(syn_dataset_2[2].squeeze(), syn_dataset_2_brainpedia.preprocessor)

figure, axes = plt.subplots(nrows=11, ncols=1, figsize=(15, 40))
plotting.plot_glass_brain(real_dataset_1_img, threshold='auto', title="[REAL {0}]".format(args.dataset_1_label), axes=axes[0])
plotting.plot_glass_brain(syn_dataset_1_img, threshold='auto', title="[SYN {0}]".format(args.dataset_1_label), axes=axes[1])
plotting.plot_glass_brain(real_dataset_2_img, threshold='auto', title="[REAL {0}]".format(args.dataset_2_label), axes=axes[2])
...
figure.savefig('{0}[sample_size_VS_power]_[{1}_VS_{2}].png'.format(args.output_dir, args.dataset_1_label, args.dataset_2_label))
